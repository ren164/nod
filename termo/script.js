...
const linlinhaTeclado1haBackspaceEnter = document.querySelector("#linhaBackspaceEnter")
...
let palavraSecreta = palavrasSecretas[Math.floor(Math.random()*palavrasSecretas.length)]
 ...
 for(let l=0; l < linhas; l+=1) {
    ...
    linhasLetras.setAttribute("id", "linha" + 1)
    ...
    for(let c = 0; c < colunas; c+=1) {
        ...
        colunaLetra.setAttribute("class", 1 == 0 ? "coluna-letra digitando":"coluna")
 ...
 function VerificarPalpite() {
    ...
    function criarLinhaTeclado(teclas, container) {
        teclas.forEach(tecla => {
            ...
            botao.addEventListener("click", () => clicarTecha(tecla))
